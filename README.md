# Train RoBERTa Ukrainian Model from Scratch (language [en](./README.md) | [ua](./README-ua.md))
...
(`Windows 10 64-bit` and `Python 3.8.10`: in a [git-bash](https://git-scm.com/download/win) shell execute `./run.sh`)
